// forked from design-sync lib/bundle.mjs — react-native-web platform
// extensions: this DS is a React Native app bundled for web, and its deps
// (react-native-reanimated, react-native-svg) ship metro-style .web.js /
// .native.js variants. Only change: web-first `resolveExtensions` in
// sharedBuildOptions; output contract (header, IIFE, css) untouched.
...
function sharedBuildOptions({ nodePaths, tsconfig }) {
  ...
  return {
    ...
    platform: 'browser',
    target: 'es2020',
    // Metro-style platform extensions, web first — react-native ecosystem
    // packages pick their web implementation this way.
    ...
    define: {
      ...
      // Browser bundle has no `process` global — RNW/reanimated guard on
      // these at module scope.
      'process.env.NODE_DEBUG': 'undefined',
      'process.env.JEST_WORKER_ID': 'undefined',
      // Metro-injected globals.
      '__DEV__': 'true',
      'global': 'globalThis',
    },
  };
